package com.akp.cp.map.TreeMap;
...
public class TreeMapTest {
	public static void main(String[] args) {
		...
		TreeMapTest.mapIterator(carOwners);
		...
		TreeMapTest.mapIterator(priceFilterMap);
		...
		TreeMapTest.mapIterator(customOrderMap);
	}
	...
	public static void mapIterator(Map<Car, Owner> map) {
		...
		while (mapItr.hasNext()) {
			...
			System.out.println(
					"Car:" + entry.getKey() + " Price:" + entry.getKey().getPrice() + " Owner:" + entry.getValue());
		}
	}
}
