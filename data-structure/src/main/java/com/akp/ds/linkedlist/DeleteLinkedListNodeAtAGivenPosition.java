...
public class DeleteLinkedListNodeAtAGivenPosition {
	...
	/*
	 * Drier program to test above functions. Ideally this function should be in a
	 * separate user class. It is kept here to keep code compact
	 */
	public static void main(String[] args) {

		DeleteLinkedListNodeAtAGivenPosition llist = new DeleteLinkedListNodeAtAGivenPosition();
		llist.push(7);
		llist.push(1);
		llist.push(3);
		llist.push(2);
